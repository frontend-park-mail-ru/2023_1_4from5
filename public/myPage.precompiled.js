...
templates['myPage'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <h5>Пост: "
    ...
    + "</h5>\n        <p>"
    + alias4(((helper = (helper = lookupProperty(helpers,"text") || (depth0 != null ? lookupProperty(depth0,"text") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"text","hash":{},"data":data,"loc":{"start":{"line":7,"column":11},"end":{"line":7,"column":19}}}) : helper)))
    + "</p>\n";
  ...
  return "<div>\n    <h1>"
    ...
    + " подписчиков</p>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"posts") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":5,"column":4},"end":{"line":8,"column":13}}})) != null ? stack1 : "")
    + "</div>";
},"useData":true});
})();